 ...
 */
package org.openhab.binding.husqvarnaam.internal.protocol.serial;
...
/**
 * 
 * A class that wraps the communication to a AM device through a
 * serial port
 * 
 * @author Antoine Besnard - Initial contribution
 */
public class SerialAmConnection extends StreamAmConnection {

    private final Logger logger = LoggerFactory
            .getLogger(SerialAmConnection.class);
    ...
    public SerialAmConnection(String portName) {
    ...
    protected void openConnection() throws IOException {
        if (isPortNameExist(portName)) {
            ...
            throw new IOException("Serial port with name " + portName
                    + " does not exist. Available port names: "
